      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SMK Sore Tulungagung <?= date("Y") ?> - Sistem Absensi </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
        ...
        <div class="modal-dialog rounded-0 modal-dialog-centered" role="document">
          <div class="modal-content rounded-0">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Apakah Kamu yakin akan keluar dari aplikasi ini?</h5>

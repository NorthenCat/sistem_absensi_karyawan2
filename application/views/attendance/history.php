  ...
  <div class="card rounded-0 shadow mb-3">
    <div class="card-body">
      <fieldset class="border rounded-0 px-2 pb-2">
        <legend class="ml-3 px-3 w-auto">Saring Laporan</legend>
          ...
          <div class="row">
            ...
            <div class="col-2">
              <button type="submit" class="btn btn-primary btn-sm rounded-0 bg-gradient-primary "><i
                  class="fa fa-file"></i> Show Attendance</button>
            </div>
          </div>
        </form>
      </fieldset>
  ...
  <?php if ($data['attendance']): ?>
    <div class="card shadow mb-4 rounded-0">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark">Data Kehadiran</h6>
      </div>
      <div class="card-body">
                ...
                <tr <?php if (date('l', $atd['date']) == 'Sunday') {
                  ...
                  if (date('l', $atd['date']) == 'Sunday'): ?>
                    ...
                    <td>
                      ...
                      <?php if ((!empty($atd['latitude']) || !empty($atd['longtitude'])) && $atd['latitude'] != 0): ?>

          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <select class="form-control form-control-sm rounded-0" name="dept">
                <option disabled>Departmen</option>
                <?php foreach ($department as $d): ?>
                  <option <?= !empty($this->input->get('dept')) && $this->input->get('dept') == $d['id'] ? 'selected' : '' ?>
                    value="<?= $d['id']; ?>">
                    <?= $d['id']; ?>
                  </option>
                <?php endforeach; ?>
        ...
        <div class="card-header py-3">
          <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-right">
              <a href="<?= base_url('report/print/') . $start . '/' . $end . '/' . $dept_code ?>" target="blank"
                class="btn btn-sm btn-light bg-gradient-light border shadow-sm rounded-0"><i
                  ...
                  <tr>
                    ...
                    <td class="p-1 align-middle">
                      <div style="line-height:1em">
                        <div class="text-xs">
                          <?= date("h:i A", strtotime('2022-06-23 ' . $atd['start'])) ?>
                        </div>
                        <div class="text-xs">
                          <?= date("h:i A", strtotime('2022-06-23 ' . $atd['end'])) ?>
                        </div>
                      </div>
                    </td>
                    <td class="p-1 align-middle">
                      <?= date('h:i:s A', $atd['date']) ?>
                    </td>
                    <td class="p-1 align-middle">
                      <?php if ($atd['notes'] == '') {
                        echo 'Unfilled';
                    ...
                    <td class="p-1 align-middle">
                      <?= $atd['out_time'] > 0 ? date('h:i:s A', $atd['out_time']) : 'Haven\'t Checked Out'; ?>
                    </td>
                    <td class="p-1 align-middle">
                      <?= $atd['out_status']; ?>
                    </td>
                    <td class="text-center">
                      ...
                      <?php if (!empty($atd['latitude']) && !empty($atd['longtitude']) && $atd['latitude'] != 0 && $atd['longtitude'] != 0): ?>
                        <a href="https://www.google.com/maps?q=<?= $atd['latitude'] ?>,<?= $atd['longtitude'] ?>"

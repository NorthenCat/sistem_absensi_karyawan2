...
<div class="container-fluid">
  ...
  <div class="row justify-content-center">
    <form action="<?= base_url('learning/addClass') ?>" method="POST" class="col-lg-5 col-md-6 col-sm-12  p-0">
      <div class="card rounded-0">
        <h5 class="card-header">Data Kelas</h5>
        <div class="card-body">
          <h5 class="card-title">Tambah Kelas Baru</h5>
          <p class="card-text">Formulir untuk menambahkan kelas baru ke sistem</p>
          <form>

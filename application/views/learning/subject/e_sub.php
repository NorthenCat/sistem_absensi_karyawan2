...
<div class="container-fluid">
  ...
  <div class="row justify-content-center">
    <form action="<?= base_url('learning/editSub') ?>" method="POST" class="col-lg-5 col-md-6 col-sm-12  p-0">
      <div class="card rounded-0">
        <h5 class="card-header">Ubah Mata Pelajaran</h5>
        <div class="card-body">
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" value="<?= $mapel['mapel'] ?>" class="form-control form-control-lg" name="d_name"

...
<div class="container-fluid">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 justify-content-end d-flex align-items-center">
      <a href="<?= base_url('master/a_shift'); ?>"
        class="btn btn-primary btn-sm bg-gradient-danger rounded-0 btn-icon-split">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Table Data Shift</h6>
    </div>
    <div class="card-body">
